...
export const MutationalMatrix: React.FC<MutationalMatrixProps> = ({ sequence }) => {
    ...
    return (
        <div className="h-full w-full flex flex-col">
            ...
            {/* Large spacing before interpretation section */}
                ...
                {interpretation && (
                    <div>
                        <button
                            ...
                            className="w-full flex items-center justify-between p-5 bg-white hover:bg-slate-50 transition-colors rounded-lg border-2 border-indigo-200 hover:border-indigo-300 shadow-sm"
                        >
                            <div className="flex items-center gap-3">
                                <Brain className="w-6 h-6 text-indigo-600" />
                                <div className="text-left">
                                    <h4 className="font-semibold text-lg text-slate-800">AI-Powered Mutational Interpretation</h4>
