...
import { ChevronDown, ChevronUp, Award, AlertTriangle, Target, TrendingUp, TrendingDown, Info } from 'lucide-react';

interface BFIInterpretationPanelProps {
    interpretation: InterpretationResult;
}

export const BFIInterpretationPanel: React.FC<BFIInterpretationPanelProps> = ({ interpretation }) => {
