    ...
    const handleAnalyze = async () => {
        ...
        try {
            const [analyzeRes, explainRes] = await Promise.all([
                axios.post(api.analyze, { sequence }),
                axios.post(api.explain, { sequence })
            ]);
                    ...
                    <div className="space-y-8">
                        ...
                        {data && data.descriptors.disorder && (
                            <div>
                                ...
                                <DisorderPlot sequence={sequence} profile={data.descriptors.disorder.disorder_profile} />
                            </div>
                        )}
                    </div>
                </CardContent>
                    ...
                    {activeTab === 'overview' && (
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                <SequenceSummaryCard sequence={sequence} data={data} />
                                <ResidueDistributionCard sequence={sequence} />
                                <DisorderLLPSCard data={data} />
                            </div>
                                ...
                                {data && (
                                    <>
                                        ...
                                        <Card className="bg-white/80 backdrop-blur-sm border-slate-200 shadow-md">
                                            ...
                                            <CardContent>
                                                <HydrophobicityPlot data={data.descriptors.physicochemical} />
                                            </CardContent>
                                        </Card>

                                        <SecondaryStructureCard data={data.descriptors.secondary_structure} />
                                    </>
                                )}
                                {!data && (
                                    <Card className="bg-white/80 backdrop-blur-sm border-slate-200 shadow-md">
                                        <CardContent className="p-12 text-center text-slate-500">
                                            Analyze a sequence to view structure insights
                                        </CardContent>
                                    </Card>
                                )}
                            </div>
